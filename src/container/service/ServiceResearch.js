                ...
                <div className="row">
                    ...
                    <div className="col-xl-5 col-lg-6 col-12" data-aos="fade-up" data-aos-delay="300">
                        <div className="about-content-area">
                            ...
                            <p>Little Southwest provides research to support historical claims, policy development, governance, and litigation. We can assembly teams of experts to meet any research need.</p>
