    ...
    return (
        <div className="section section-padding-t90 section-padding-bottom-200">
            <div className="container">
                ...
                <SectionTitle
                    title="Little Southwest Consulting Inc"
                    // subTitle="We provide training and consulting services to First Nations and Indigenous organizations and businesses and government working with Indigenous peoples."
                />
                    ...
                    <div className="col-xl-5 col-lg-6 col-12" data-aos="fade-up" data-aos-delay="300">
                        <div className="about-content-area">
                            <SectionTitleTwo 
                                ...
                                title="Focused on Research, Governance, and Training"
                            />
