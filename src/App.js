        ...
        <NavScrollTop>
          <Suspense fallback={<div />}>
                <Routes>
                  ...
                  <Route path={`${process.env.PUBLIC_URL + "/training"}`} element={<Training/>} />
                  <Route path={`${process.env.PUBLIC_URL + "/research"}`} element={<Research/>} />
                  <Route path={`${process.env.PUBLIC_URL + "/governance"}`} element={<Governance/>} />
